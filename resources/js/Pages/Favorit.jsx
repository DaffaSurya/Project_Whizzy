          ...
          <ul className="mt-7 grid grid-cols-2 justify-items-center px-4 gap-5">
            <li className="border border-white rounded">
              <a href="#" className="group block overflow-hidden">
                ...
                <div className="relative bg-black pt-3 flex p-2 gap-1">
                  <h3 className="text-lg text-white group-hover:underline group-hover:underline-offset-6 font-weight-600">
                    Bumi Manusia
                  </h3>
            ...
            <li className="border border-white rounded">
              <a href="#" className="group block overflow-hidden">
                ...
                <div className="relative bg-black pt-3 flex p-2 gap-2">
                  <h3 className="text-lg text-white group-hover:underline group-hover:underline-offset-4 font-weight-600">
                    Anak Bangsa
                  </h3>
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"><path fill="#ffe786" d="M4 22V8q0-.825.588-1.412T6 6h8q.825 0 1.413.588T16 8v14l-6-3zm14-4V4H7V2h11q.825 0 1.413.588T20 4v14z" /></svg>
                </div>
